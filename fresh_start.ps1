...
cd D:\Coding\forecasting_instruments_influence_accounts
...
uv run python x_tweets_retriever.py --since 20260615
...
uv run python backtest_simulator.py 202607020900 --from 202411010000
