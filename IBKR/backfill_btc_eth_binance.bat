...
echo  Bar sizes: 30m, 15m, 5m, 1m
echo ============================================================

echo.
echo [1/4] 30-minute bars...
python fetch_binance_history.py --bar-size 30m --from 20170801

echo.
echo [2/4] 15-minute bars...
python fetch_binance_history.py --bar-size 15m --from 20170801

echo.
echo [3/4] 5-minute bars...
...
echo.
echo ============================================================
echo  All bar sizes complete (30m, 15m, 5m, 1m).
